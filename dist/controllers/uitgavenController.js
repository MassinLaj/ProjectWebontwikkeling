...
var voegUitgaveToe = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, beschrijving, bedrag, valuta, uitgave;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, beschrijving = _a.beschrijving, bedrag = _a.bedrag, valuta = _a.valuta;
                uitgave = new uitgave_1.Uitgave({ beschrijving: beschrijving, bedrag: bedrag, valuta: valuta });
